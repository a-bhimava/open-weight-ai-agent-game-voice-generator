...
|---|---|---|---|
| 1 | [01_Audiobook_Studio_MVP.ipynb](./01_general_tts/01_Audiobook_Studio_MVP.ipynb) | Long-form audiobook narration with consistent voice | `1.7B-Base` |
| 2 | [02_MultiSpeaker_Drama_MVP.ipynb](./01_general_tts/02_MultiSpeaker_Drama_MVP.ipynb) | Multi-character podcast & drama from script format | `1.7B-CustomVoice` |
| 3 | [03_Voice_Clone_Studio_MVP.ipynb](./01_general_tts/03_Voice_Clone_Studio_MVP.ipynb) | Zero-shot voice cloning workbench (3–15s reference) | `1.7B-Base` |
| 4 | [04_Voice_Designer_Foundry_MVP.ipynb](./01_general_tts/04_Voice_Designer_Foundry_MVP.ipynb) | Prompt engineering studio for voice persona design | `1.7B-VoiceDesign` |
| 5 | [05_Multilingual_Dubber_MVP.ipynb](./01_general_tts/05_Multilingual_Dubber_MVP.ipynb) | TTS across all 10 supported languages | `1.7B-CustomVoice` |
| 6 | [06_News_RSS_Podcast_MVP.ipynb](./01_general_tts/06_News_RSS_Podcast_MVP.ipynb) | Fetch live RSS news → spoken morning briefing | `1.7B-VoiceDesign` |
| 7 | [07_PDF_Document_Reader_MVP.ipynb](./01_general_tts/07_PDF_Document_Reader_MVP.ipynb) | Convert PDF / .md / .txt files to narrated audio | `1.7B-VoiceDesign` |
| 8 | [08_Game_NPC_Voice_MVP.ipynb](./01_general_tts/08_Game_NPC_Voice_MVP.ipynb) | NPC voice foundry for games & tabletop RPGs | `1.7B-VoiceDesign` |
| 9 | [09_Colab_Webhook_API_MVP.ipynb](./01_general_tts/09_Colab_Webhook_API_MVP.ipynb) | Colab as a live REST API (FastAPI + Cloudflare Tunnel) | `0.6B-CustomVoice` |
| 10 | [10_AllInOne_Gradio_App_MVP.ipynb](./01_general_tts/10_AllInOne_Gradio_App_MVP.ipynb) | 5-tab Gradio web app with shareable public URL | Switchable |
...
| # | Notebook | Description | Model |
|---|---|---|---|
| 11 | [11_RPG_Class_Voice_Pack_MVP.ipynb](./02_game_npc_voices/11_RPG_Class_Voice_Pack_MVP.ipynb) | 8 RPG classes × 3 event lines (greeting, combat, death) + party intro scene | `1.7B-VoiceDesign` |
| 12 | [12_Horror_Dark_Entity_Pack_MVP.ipynb](./02_game_npc_voices/12_Horror_Dark_Entity_Pack_MVP.ipynb) | 6 horror archetypes (ghost, demon, cult leader, possessed, undead, eldritch) | `1.7B-VoiceDesign` |
| 13 | [13_SciFi_Species_Pack_MVP.ipynb](./02_game_npc_voices/13_SciFi_Species_Pack_MVP.ipynb) | 6 sci-fi species (hivemind, rogue AI, cyborg, mutant, diplomat, machine god) | `1.7B-VoiceDesign` |
| 14 | [14_Companion_Voice_Set_MVP.ipynb](./02_game_npc_voices/14_Companion_Voice_Set_MVP.ipynb) | Full 41-line companion event library via Design → Clone pipeline | `1.7B-VoiceDesign` + `1.7B-Base` |
| 15 | [15_Boss_Battle_Monologue_MVP.ipynb](./02_game_npc_voices/15_Boss_Battle_Monologue_MVP.ipynb) | 4 bosses × 3-phase encounter (intro → taunts → death speech) + selection reel | `1.7B-VoiceDesign` |
| 16 | [16_Branching_Dialogue_Tree_MVP.ipynb](./02_game_npc_voices/16_Branching_Dialogue_Tree_MVP.ipynb) | Dialogue tree with player-choice branches, tree-aware filenames & JSON manifest | `1.7B-VoiceDesign` |
| 17 | [17_Dynamic_Emotion_Engine_MVP.ipynb](./02_game_npc_voices/17_Dynamic_Emotion_Engine_MVP.ipynb) | 8 emotions × 3 intensities = 24-clip reactive voice grid | `1.7B-VoiceDesign` |
| 18 | [18_Voice_Aging_System_MVP.ipynb](./02_game_npc_voices/18_Voice_Aging_System_MVP.ipynb) | Same character at young / adult / elder ages — life story arcs | `1.7B-VoiceDesign` |
| 19 | [19_Ambient_Crowd_Chatter_MVP.ipynb](./02_game_npc_voices/19_Ambient_Crowd_Chatter_MVP.ipynb) | 5 scene types → loopable ambient audio beds (market, tavern, battlefield, dungeon, space station) | `1.7B-CustomVoice` |
| 20 | [20_Procedural_NPC_Generator_MVP.ipynb](./02_game_npc_voices/20_Procedural_NPC_Generator_MVP.ipynb) | Genre seed → deterministic unique NPC (name + backstory + voice + lines) | `1.7B-VoiceDesign` |
...
| # | Notebook | Description | Model |
|---|---|---|---|
| 21 | [21_Character_Voice_Aging_MVP.ipynb](./03_character_archetypes/21_Character_Voice_Aging_MVP.ipynb) | Complete aging system (8 archetypes × 4 life stages + life story montages) | `1.7B-VoiceDesign` |
...
- [Qwen3_TTS_Colab.ipynb](./reference/Qwen3_TTS_Colab.ipynb) — Complete reference notebook with all Qwen3-TTS features
